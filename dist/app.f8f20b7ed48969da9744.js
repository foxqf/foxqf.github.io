...
function(e) {
    ...
    u = function() {
        ...
        },
        {
            key: "addClass",
            value: function(e) {
                return this.optimizeCb(function(t) { - 1 === t.className.split(" ").indexOf(e) && (t.className += " " + e)
                }),
                this
            }
        },
...
function(e, t, n) {
    ...
    u = r(l),
    h = (0, a.
default)("#app .resume-wrap"),
    c = h.get(0),
    p = (0, a.
default)(".resume-tag", c),
    g = (0, a.
default)(".resume-markdown", c),
    f = "",
    d = s.
default.length,
    m = null,
    ...
    k = function(e) {
        ...
        m = setInterval(function() {
            f += s.
        default.substring(b, b + 1),
            f.length === d ? (clearInterval(m), e && e()) : (g.html(f), b++)
        },
        60)
    };
    e.exports = {
...
default)("pre", c),
    ...
    default[e],
        ...
        i = void 0;
        n && (r = s.
    default.filter(function(t, n) {
            return n <= e
        }).reduce(function(e, t) {
            return e += t.length
        },
        0), i = r - n.length, clearInterval(d), d = setInterval(function() {
            var e = f.length - i,
            s = n.substring(e, e + 1) || "";
            if (f += s, f.length === r) clearInterval(d),
            t && t();
            else {
                var o = g.height() - m;
                o > 0 && b(o),
                p.html(f),
                g.html(u.
            default.highlight(f, u.
            default.languages.css))
            }
        },
        60))
    };
...
function(e, t, n) { (function(t) { (function() {
            ...
            function n(e, t) {
                if (this.options = t || h.defaults, this.links = e, this.rules = p.normal, this.renderer = this.options.renderer || new r, this.renderer.options = this.options, !this.links) throw new Error("Tokens array requires a `links` property.");
            ...
            function h(e, n, r) {
                if (r || "function" == typeof n) {
                    ...
                    for (; c < o.length; c++) !
                    function(e) {
                        "code" !== e.type ? --a || p() : l(e.text, e.lang,
                        function(t, n) {
            ...
            c.list = a(c.list)(/bull/g, c.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + c.def.source + ")")(),
            ...
            c.html = a(c.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, c._tag)(),
            c.paragraph = a(c.paragraph)("hr", c.hr)("heading", c.heading)("lheading", c.lheading)("blockquote", c.blockquote)("tag", "<" + c._tag)("def", c.def)(),
            c.normal = u({},
            c),
            c.gfm = u({},
            c.normal, {
            ...
            c.gfm.paragraph = a(c.paragraph)("(?!", "(?!" + c.gfm.fences.source.replace("\\1", "\\2") + "|" + c.list.source.replace("\\1", "\\3") + "|")(),
            c.tables = u({},
            c.gfm, {
                nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
                table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
            ...
            t.prototype.token = function(e, t, n) {
                for (var r, i, s, o, a, l, u, h, p, e = e.replace(/^ +$/gm, ""); e;) if ((s = this.rules.newline.exec(e)) && (e = e.substring(s[0].length), s[0].length > 1 && this.tokens.push({
                    type: "space"
                ...
                this.tokens.push({
                    ...
                    for (e = e.substring(s[0].length), o = s[2], this.tokens.push({
                        type: "list_start",
                        ordered: o.length > 1
                    }), s = s[0].match(this.rules.item), r = !1, p = s.length, h = 0; h < p; h++) l = s[h],
                    u = l.length,
                    l = l.replace(/^ *([*+-]|\d+\.) +/, ""),
                    ~l.indexOf("\n ") && (u -= l.length, l = this.options.pedantic ? l.replace(/^ {1,4}/gm, "") : l.replace(new RegExp("^ {1," + u + "}", "gm"), "")),
                    this.options.smartLists && h !== p - 1 && (a = c.bullet.exec(s[h + 1])[0], o === a || o.length > 1 && a.length > 1 || (e = s.slice(h + 1).join("\n") + e, h = p - 1)),
                    i = r || /\n\n(?!\s*$)/.test(l),
                ...
                else if (!n && t && (s = this.rules.def.exec(e))) e = e.substring(s[0].length),
            ...
            n.prototype.output = function(e) {
                ...
                o += this.renderer.link(r, null, n);
                    ...
                    o += this.renderer.codespan(s(i[2], !0));
        ...
        r = function() {
            ...
            r = n.Prism = {
                ...
                highlightElement: function(t, i, s) {
                    ...
                    l && (o = (l.className.match(e) || [, ""])[1].toLowerCase(), a = r.languages[o]),
                    ...
                    if (r.hooks.run("before-sanity-check", h), !h.code || !h.grammar) return h.code && (h.element.textContent = h.code),
                    ...
                    } else h.highlightedCode = r.highlight(h.code, h.grammar, h.language),
                    r.hooks.run("before-insert", h),
                    h.element.innerHTML = h.highlightedCode,
                    s && s.call(t),
                    r.hooks.run("after-highlight", h),
                        ...
                        for (var u = 0; u < l.length; ++u) {
                            ...
                            y = 0; b < s.length; y += s[b].length, ++b) {
                                ...
                                if (! (k instanceof i)) {
                                    ...
                                    v = 1;
                                    if (!x && g && b != s.length - 1) {
                                        if (h.lastIndex = y, !(x = h.exec(e))) break;
                                        for (var w = x.index + (p ? x[1].length: 0), _ = x.index + x[0].length, S = b, $ = y, A = s.length; S < A && $ < _; ++S) $ += s[S].length,
                                        w >= $ && (++b, y = $);
                                    ...
                                    if (x) {
                                        ...
                                        L = [b, v];
                                        C && L.push(C);
                                        var q = new i(a, c ? r.tokenize(x, c) : x, d, x, g);
                                        L.push(q),
                                        j && L.push(j),
                                        Array.prototype.splice.apply(s, L)
                                    }
                                }
                            }
                        }
            ...
            function(e) {
                ...
                s = t.code,
                o = t.immediateClose;
                n.postMessage(r.highlight(s, r.languages[i], i)),
                o && n.close()
            },
            !1), n.Prism) : n.Prism;
            var s = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
            return s && (r.filename = s.src, document.addEventListener && !s.hasAttribute("data-manual") && ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(r.highlightAll) : window.setTimeout(r.highlightAll, 16) : document.addEventListener("DOMContentLoaded", r.highlightAll))),
            n.Prism
        } ();
